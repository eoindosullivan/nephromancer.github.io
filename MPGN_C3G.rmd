...
[case series](https://pubmed.ncbi.nlm.nih.gov/30420049/)
...
The renal bx and bone marrow dont match? (e.g. you suspect MPGN from K/L light chains based on marrow but arnt seeing that on the renal bx) 
-   request a paraffin-IF with Pronase digestion and a stain with Heavy-Light chain hybrid antibody to sub-type the IgG
-   immuno-gold EM to see if the electron dense deposits are composed of a monoclonal light chain.
