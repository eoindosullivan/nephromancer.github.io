...
-   Plasma Renin threshold (ng/mL/h): \<1.0 ( i.e. supressed)
-   Serum Aldosterone (ng/dL): \>= 15 ( other thresholds exist e.g. 20 is conversative, 6 is too permissive. 15 is fairly widely accepted)
-   ARR (ng/dL per ng/mL/h) \>= 30
