...
Almost all patterns of injury can occur. The unique factor is that a **monocloncal protein may light up on the IF.** Hence the benefit of doing Kappa and Lamda and CD3,CD20 when suspicious.
