...
Approach as standard TMA emergency and requires rapid Dx: urgent ADAMTS13, APL abx, complement studies, decide if TTP - PLASMIC score ( PEX/ITU right now). KDIGO 21 has a flow chart
...
-   Class 2 generally do not need specific therapy for their kidney disease but may need immunosuppressive treatment for extrarenal SLE manifestations. 
  ...
  -   If nephrotic, class 1 & 2 over 90% of patients given glucocorticoid monotherapy achieved remission within a median time of 4 week, high risk of flares so CNI/MPAA/AZA (KDIGO 21)
...
**Methylpred:** 0.5-1g/kg for 1-3 days, then oral pred 1mg/kg/day (ideal body weight) max 80mg taper over weeks to a maintanence dose
...
- There is an emerging role for Blymphocyte targeting biologics in the treatment of LN.
